...
const packageRaainJsonPath = path.resolve(__dirname, '../package.raain.json');

// Read the package files
const packageJson = require(packageJsonPath);
const packageRaainJson = require(packageRaainJsonPath);
...
const dependencies = mode === 'local'
  ? packageRaainJson['local.dependencies']
  : packageRaainJson['remote.dependencies'];
